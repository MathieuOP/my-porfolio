...
var trans2 = function trans2(x, y) {
  return "translate3d(".concat(x / 6 + 920, "px,").concat(y / 6 - 240, "px,0)");
};

var trans3 = function trans3(x, y) {
  return "translate3d(".concat(x / 7 - 780, "px,").concat(y / 7 + -80, "px,0)");
};

var trans4 = function trans4(x, y) {
  return "translate3d(".concat(x / 7 - 300, "px,").concat(y / 7 + -390, "px,0)");
};
...
var Card2 = function Card2(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    className: "discovery--science--pic6" // style={{ transform: p.xy.interpolate(trans1) }}
