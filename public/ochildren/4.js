...
var trans1 = function trans1(x, y) {
  return "translate3d(".concat(x / 7 + 460, "px,").concat(y / 7 - 300, "px,0)");
};

var trans2 = function trans2(x, y) {
  return "translate3d(".concat(x / 7 - 350, "px,").concat(y / 7 - -140, "px,0)");
};

var trans3 = function trans3(x, y) {
  return "translate3d(".concat(x / 4 + -140, "px,").concat(y / 4 - -380, "px,0)");
};

var trans4 = function trans4(x, y) {
  return "translate3d(".concat(x / 7 + -180, "px,").concat(y / 7 - 20, "px,0)");
};

var trans5 = function trans5(x, y) {
  return "translate3d(".concat(x / 7 - -50, "px,").concat(y / 7 - -380, "px,0)");
};

var trans6 = function trans6(x, y) {
  return "translate3d(".concat(x / 7 + 280, "px,").concat(y / 7 - 160, "px,0)");
};
...
var Card1 = function Card1(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    trigger: react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], {
      className: "discovery--nature--pic2",
      src: data.pics[1].image_url // exemple
