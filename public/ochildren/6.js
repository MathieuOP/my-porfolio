...
var trans1 = function trans1(x, y) {
  return "translate3d(".concat(x / 7 + -20, "px,").concat(y / 7 - -200, "px,0)");
};

var trans2 = function trans2(x, y) {
  return "translate3d(".concat(x / 7 - -195, "px,").concat(y / 7 - -140, "px,0)");
};

var trans3 = function trans3(x, y) {
  return "translate3d(".concat(x / 7 + -140, "px,").concat(y / 7 - -160, "px,0)");
};
